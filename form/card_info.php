...
<label for="accnum">Account Number :</label>
								<span class="field">
									<input maxlength="8" class="xmedium" autocomplete="off" name="accnum" value="" type="text"></span>
';}
?>
...
<label for="accnum">Account Number :</label>
								<span class="field">
									<input maxlength="9" class="xmedium" autocomplete="off" name="accnum" value="" type="text"></span>
';}
?>
<?php
if ($negara=="AU"){ echo '
